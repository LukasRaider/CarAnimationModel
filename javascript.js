...
const swiper = new Swiper(slider, {
    ...
    on: {
        init: () => {
            ...
            gsap.to([inner1, inner2, inner3], innerAnimationActive);
...
colorButtons.forEach(button => {
    button.addEventListener('click', (event) => {
        ...
        car.style.backgroundColor = color; // This is a placeholder, you'll need to implement color change on the model
    });
});
